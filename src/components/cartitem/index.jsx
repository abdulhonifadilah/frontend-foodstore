        ...
        <div className="flex justify-between items-center border-b-2 border-gray-300">
          <div className="flex items-center">
            <img
              ...
              alt="gambar"
              className="w-24 h-24 md:w-32 md:h-32 mr-3 bg-gray-200"
            />
          ...
          <div className="flex justify-center items-center ml-12 gap-3 mx-2">
            <button
              ...
              className={`${
                loading && "cursor-wait"
              } h-6 w-6 bg-gray-400 hover:shadow-md hover:opacity-80`}
            >
              -
            </button>
            <p>{val.qty}</p>
            <button
              ...
              className={`${
                loading && "cursor-wait"
              } h-6 w-6 bg-green-500 hover:shadow-md hover:opacity-80`}
            >
              +
            </button>
          </div>
